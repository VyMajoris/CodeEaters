...
//		 */
//		// Cria o primeiro pacote, com data de saida para 23/09/2013 e
//		// transporte1 = GOL (vide acima)
//		Calendar dtSaida1 = Calendar.getInstance();
//		dtSaida1.set(2013, 8, 23);
//		Avaliacao pacote1 = new Avaliacao("Porto de Galinhas", dtSaida1, 7,
//				2000, transporte1);
//
//		// Cria o segundo pacote, com data de saida para 20/05/2013 e
//		// transporte1 = GOL (vide acima)
//		Calendar dtSaida2 = Calendar.getInstance();
//		dtSaida2.set(2013, 4, 20);
//		Avaliacao pacote2 = new Avaliacao("Natal", dtSaida2, 10, 2300,
//				transporte1);
//
//		// Cria o terceiro pacote, com data de saida para 13/06/2013 e
//		// transporte2 = COMETA (vide acima)
//		Calendar dtSaida3 = Calendar.getInstance();
//		dtSaida3.set(2013, 6, 13);
//		Avaliacao pacote3 = new Avaliacao("Bonito", dtSaida3, 8, 500,
//				transporte2);
//
//		// Cria o quarto pacote, com data de saida para 01/12/2013 e transporte3
//		// = MSC Cruzeiros (vide acima)
//		Calendar dtSaida4 = Calendar.getInstance();
//		dtSaida4.set(2013, 8, 23);
//		Avaliacao pacote4 = new Avaliacao("Cancun", dtSaida4, 10, 6000,
//				transporte3);
//
...
//		 */
//		// Cria um cliente com endereço, data de nascimento 19/08/1983 e lista
//		// de pacotes com pacotes 1 e 2
//		Assistente end1 = new Assistente("Rua Lins de Vasconcelos", 12898999,
//				cidade2);
...
//		Identificacao cliente1 = new Identificacao("Thiago", "98728018736",
//				dtNasc1, end1, listPac1);
//
//		// Cria um cliente com endereço, data de nascimento 02/02/1990 e lista
//		// de pacotes com pacotes 1 e 4
//		Assistente end2 = new Assistente("Rua Duque de Caxias, 2-90", 17017519,
//				cidade1);
...
//		Identificacao cliente2 = new Identificacao("Leandro", "50293494030",
//				dtNasc2, end2, listPac2);
//
//		// Cria um cliente com endereço, data de nascimento 24/02/1999 e lista
//		// de pacotes com pacotes 2, 3 e 4
//		Assistente end3 = new Assistente("Rua 23 de janeiro, 900", 12892309,
//				cidade3);
...
//		Identificacao cliente3 = new Identificacao("Maria", "99828771111",
//				dtNasc3, end3, listPac3);
//
//		// Cria um cliente com endereço, data de nascimento 19/01/2000, lista de
//		// pacotes com pacote 1 e reserva
...
//		Identificacao cliente4 = new Identificacao("João", "90028383848",
//				dtNasc4, end4, listPac4);
//
//		// Cria um cliente com endereço, data de nascimento 19/08/1083 e lista
//		// de pacotes com pacotes 1, 2, 3 e 4
//		Assistente end5 = new Assistente("Rua Lins de Vasconcelos", 12890000,
//				cidade1);
...
//		Identificacao cliente5 = new Identificacao("Julio", "88892992922",
//				dtNasc5, end5, listPac5);
//
...
//		Especialidade reserva1 = new Especialidade(10, dtReseva1, pacote1,
//				cliente2);
//
//		Calendar dtReseva2 = Calendar.getInstance();
//		dtReseva2.set(2013, 2, 20);
//		Especialidade reserva2 = new Especialidade(10, dtReseva2, pacote4,
//				cliente5);
//
